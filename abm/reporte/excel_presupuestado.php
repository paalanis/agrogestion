...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Reporte - Presupuesto')
            ->setCellValue('A2', 'Mes')
			->setCellValue('B2', 'Año')
            ->setCellValue('C2', 'Labor')
            ->setCellValue('D2', 'Presupuestado')
            ->setCellValue('E2', 'Unidad')
			->setCellValue('F2', 'Finca');
...
$rs = reportePresupuestado($labor,False,False);
	...
	while ($datos = mysqli_fetch_array($rs)){
            ...
            ->setCellValue($a, $mes)
            ->setCellValue($b, $anio)
            ->setCellValue($c, $labores)
            ->setCellValue($d, $total_presupuestado)
            ->setCellValue($e, $unidades)
			->setCellValue($f, $finca);
...
$objPHPExcel->getActiveSheet()->setTitle('Reporte presupuestado');
...
header('Content-Disposition: attachment;filename="reporte_presupuestado_'.$finca.'_del_mes_'.$mesInicio.'_al_'.$mesFin.'.xls"');
