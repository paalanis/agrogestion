      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal" id="formulario_reporte" role="form" method="post" action="abm/reporte/excel_presupuestario.php">
              ...
              <div class="well" style="overflow: auto">
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <fieldset>
                    <select class="form-control col-md-7 col-xs-12" name="dato_presentacion" id="dato_presentacion">
                      <option value="1">Tipo de Informe</option>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  <fieldset>
                    <select class="form-control col-md-7 col-xs-12" name="dato_modulo" id="dato_modulo" disabled>
              ...
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-0">
                  ...
                  <button type="button" id="boton_buscar" class="btn btn-primary" onclick="reporte('controlPresupuestario')">Buscar</button>
...
<script type="text/javascript">
  ...
  $(function() {
    $('#dato_presentacion').change(function() {

      var opcion = $(this).val()

      if (opcion == '2'){
        $('#dato_modulo').prop('disabled', false)
      }
      if (opcion == '1'){
        $('#dato_modulo').prop('disabled', true)
        $('#dato_modulo').val(0)
      }
