...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('A1', 'Reporte - Ejecutado')
            ->setCellValue('A2', 'Mes')
			->setCellValue('B2', 'Año')
            ->setCellValue('C2', 'Labor')
            ->setCellValue('D2', 'Ejecutado')
...
$rs = reporteEjecutado($labor,False,False);
	...
	while ($datos = mysqli_fetch_array($rs)){
		...
		$finca = $datos['finca'];
            ...
            ->setCellValue($d, $total_ejecutado)
...
$objPHPExcel->getActiveSheet()->setTitle('Reporte ejecutado');
...
header('Content-Disposition: attachment;filename="reporte_ejecutado_'.$finca.'_del_mes_'.$mesInicio.'_al_'.$mesFin.'.xls"');
