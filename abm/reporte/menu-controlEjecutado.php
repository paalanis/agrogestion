  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          <div class="x_title">
            <h2>Ejecutado <small>Reporte ejecutado</small></h2>
            <div class="clearfix"></div>
          </div>
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal" id="formulario_reporte" role="form" method="post" action="abm/reporte/excel_ejecutado.php">
              ...
              <div class="well" style="overflow: auto">
                ...
                <div class="col-md-2 col-sm-4 col-xs-12">
                  <fieldset>
                    <select class="form-control col-md-7 col-xs-12" name="dato_agrupado" id="dato_agrupado">
                      <option value="">Agrupado Labor</option>
