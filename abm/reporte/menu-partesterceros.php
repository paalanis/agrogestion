...
<div class="col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="x_panel">
    <div class="x_title">
      <h2>Reporte Terceros <small>Reporte de partes realizados por personal tercerizado</small></h2>
      <div class="clearfix"></div>
    </div>
    ...
    <div class="x_content">
      ...
      <form class="form-horizontal" id="formulario_reporte" role="form" method="post" action="abm/reporte/excel_terceros.php">
        ...
        <div class="well" style="overflow: auto">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                      <fieldset>
                      <select class="form-control col-md-7 col-xs-12" name="dato_empleadoTercerizado" id="dato_empleadoTercerizado">   
                        <option value="1">Empleado Tercerizado - NO</option>
                        <option value="0">Empleado Tercerizado - SI</option>
                      </select>
                      </fieldset>
                    </div>
        ...
        <div class="form-group">
          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-0">
             ...
             <button type="button" id="boton_buscar" class="btn btn-primary" onclick="reporte('partesterceros')">Buscar</button>
